                    ...
                    <div className="flex justify-between px-6 my-3">
                        ...
                        <div className="filters">
                            {types.map((type) => (
                                <button
                                    key={type}
                                    className={`mx-2 p-2 border-2 rounded-xl border-primary ${selectedTypes.includes(type) ? "bg-primary text-white" : ""
                                        }`}
                                    onClick={() => {
                                    ...
                                    <tr key={document.id}>
                                        ...
                                        <td className="p-2 pr-4">
                                            <div className="flex items-center justify-end ">
                                                ...
                                                <button
                                                    className="flex py-1 px-4 ml-3 bg-primary rounded-xl"
